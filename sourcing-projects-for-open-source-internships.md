...
Build a sustainable pipeline of open source internship projects through active outreach to faculty, researchers, and external partners, and/or internal project development.
...
* Clear information on mentor eligibility, for example, whether mentors need to be a maintainer or core contributor of an open source project; and if industry participants, faculty, staff, or senior students are all eligible to apply.
* An outline of the minimum time commitment expected of mentors, such as regular synchronous meetings with students and availability for asynchronous communication during working hours.
* A simple submission process, such as a short online form.
...
* Complementary programs, such as undergraduate research schemes or data science institutes, whose networks overlap with potential project mentors.
...
Partnerships with industry organisations; open source communities and foundations; and other external bodies can provide projects, co-funding, and mentorship opportunities that extend beyond what is available internally. External partnerships typically require sustained relationship-building over time. Approaches include:
...
* Exploring externally managed programs, such as Google Summer of Code, Code for GovTech or similar initiatives that provide their own project pipeline and recruitment infrastructure.
...
Faculty, researchers and external partners develop a clearer understanding of what the program offers and what is involved in participating as a project mentor.
...
* [A Guide for Open Source Maintainers: Engaging Students Effectively](https://github.com/gt-ospo/oss-student-resources/blob/main/tips-for-maintainers.md)
